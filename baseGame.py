    ...
    for row_index, row in enumerate(layout):
        for col_index, square in enumerate(row):
            ...
            if square == 'X':
                ...
                ground_pieces.append(Ground(x, y, os.path.join(os.getcwd(), 'Assets', 'M.png')))
            elif square == 'w':
                screen.blit(screen, (x, y), pygame.Rect(x, y, 20, 20))
            elif square != ' ':
                ground_pieces.append(Ground(x, y, os.path.join(os.getcwd(), 'Assets', f'{square}.png')))
